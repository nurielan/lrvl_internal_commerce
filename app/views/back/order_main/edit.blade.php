	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				{{ Form::open(['route' => 'b_brand_update', 'files' => true]) }}
					{{ Form::hidden('id', $brand->id) }}

					<div class="form-group">
						{{ Form::text('name', $brand->name, ['class' => 'form-control', 'placeholder' => 'Title']) }}
					</div>

					<div class="form-group">
						{{ Form::textarea('description', $brand->description, ['class' => 'form-control', 'placeholder' => 'Content']) }}
					</div>

					<div class="form-group">
						<div class="row">
							<div class="col-md-4 col-md-offset-4" align="center">
								<img class="img-responsive" src="{{ asset('assets/images/brand/thumbnail/'.$brand->image) }}">
							</div>
						</div>
