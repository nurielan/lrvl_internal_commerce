	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				{{ Form::open(['route' => 'b_brandsizeimage_update', 'files' => true]) }}
					{{ Form::hidden('id', $brandsizeimage->id) }}

					<div class="form-group">
						<div class="row">
							<div class="col-md-4 col-md-offset-4" align="center">
								<img class="img-responsive" src="{{ asset('assets/images/brandsizeimage/original/'.$brandsizeimage->image) }}">
							</div>
						</div>
					...
					<div class="form-group">
						<div class="btn-group btn-group-justified">
							<div class="btn-group">
								<a class="btn btn-primary" href="{{ route('b_brandsizeimage_index') }}"><span class="fa fa-arrow-left"></span>&nbsp;Back</a>
							</div>
